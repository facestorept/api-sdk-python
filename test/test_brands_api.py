...
from swagger_client.api.brands_api import BrandsApi  # noqa: E501
...
class TestBrandsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.brands_api.BrandsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_add_brands(self):
        """Test case for add_brands

        """
        pass

    def test_delete_brand_by_id(self):
        """Test case for delete_brand_by_id
    ...
    def test_update_category_by_id_0(self):
        """Test case for update_category_by_id_0
