...
from swagger_client.api.taxes_api import TaxesApi  # noqa: E501
...
class TestTaxesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.taxes_api.TaxesApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_add_taxes(self):
        """Test case for add_taxes

        """
        pass

    def test_delete_tax_by_id(self):
        """Test case for delete_tax_by_id

        """
        pass

    def test_get_tax_by_id(self):
        """Test case for get_tax_by_id
    ...
    def test_update_tax_by_id(self):
        """Test case for update_tax_by_id

        """
        pass

    def test_update_tax_by_id_0(self):
        """Test case for update_tax_by_id_0
