...
class PaymentsApi(object):
    ...
    def get_payment_by_id(self, id, **kwargs):  # noqa: E501
        """get_payment_by_id  # noqa: E501

        Returns all payments from the system that the user has access to   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_payment_by_id(id, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.get_payment_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_payment_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_payment_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_payment_by_id  # noqa: E501

        Returns all payments from the system that the user has access to   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_payment_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_payment_by_id`")  # noqa: E501
