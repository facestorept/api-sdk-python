...
class CategoriesApi(object):
    ...
    def add_categories(self, category, **kwargs):  # noqa: E501
        """add_categories  # noqa: E501

        Creates a new category in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_categories(category, async=True)
        >>> result = thread.get()

        :param async bool
        :param Category category: Category to add to the store (required)
        ...
        if kwargs.get('async'):
            return self.add_categories_with_http_info(category, **kwargs)  # noqa: E501
        else:
            (data) = self.add_categories_with_http_info(category, **kwargs)  # noqa: E501
            return data

    def add_categories_with_http_info(self, category, **kwargs):  # noqa: E501
        """add_categories  # noqa: E501

        Creates a new category in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_categories_with_http_info(category, async=True)
        >>> result = thread.get()
        ...
        if ('category' not in params or
            ...
            raise ValueError("Missing the required parameter `category` when calling `add_categories`")  # noqa: E501
    ...
    def delete_category_by_id(self, id, **kwargs):  # noqa: E501
        """delete_category_by_id  # noqa: E501

        deletes a single category based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_category_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_category_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_category_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_category_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """delete_category_by_id  # noqa: E501

        deletes a single category based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_category_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_category_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_category_by_id`")  # noqa: E501
    ...
    def get_categories(self, **kwargs):  # noqa: E501
        ...
        Returns all categories from the system that the user has access to  ### Includes You can give the following values on includes parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_category_by_id(self, id, **kwargs):  # noqa: E501
        """get_category_by_id  # noqa: E501

        Returns a category based on a single ID  ### Includes You can give the following values on includes parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_category_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_category_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_category_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_category_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_category_by_id  # noqa: E501

        Returns a category based on a single ID  ### Includes You can give the following values on includes parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_category_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_category_by_id`")  # noqa: E501
    ...
    def update_category_by_id(self, id, category, **kwargs):  # noqa: E501
        """update_category_by_id  # noqa: E501

        update a single category based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id(id, category, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_category_by_id_with_http_info(id, category, **kwargs)  # noqa: E501
        else:
            (data) = self.update_category_by_id_with_http_info(id, category, **kwargs)  # noqa: E501
            return data

    def update_category_by_id_with_http_info(self, id, category, **kwargs):  # noqa: E501
        """update_category_by_id  # noqa: E501

        update a single category based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id_with_http_info(id, category, async=True)
        >>> result = thread.get()
        ...
        if ('category' not in params or
                params['category'] is None):
            raise ValueError("Missing the required parameter `category` when calling `update_category_by_id`")  # noqa: E501
