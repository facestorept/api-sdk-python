...
class CustomersApi(object):
    ...
    def get_customer_by_id(self, id, **kwargs):  # noqa: E501
        """get_customer_by_id  # noqa: E501

        Returns all customers from the system that the user has access to  ### Includes You can give the following values on includes parameter: `orders, groups`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_customer_by_id(id, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.get_customer_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_customer_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_customer_by_id  # noqa: E501

        Returns all customers from the system that the user has access to  ### Includes You can give the following values on includes parameter: `orders, groups`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_customer_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_customer_by_id`")  # noqa: E501
