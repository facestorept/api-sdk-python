...
class ProductsApi(object):
    ...
    def add_product(self, product, **kwargs):  # noqa: E501
        """add_product  # noqa: E501

        Creates a new product in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_product(product, async=True)
        >>> result = thread.get()

        :param async bool
        :param Product product: Product to add to the store (required)
        ...
        if kwargs.get('async'):
            return self.add_product_with_http_info(product, **kwargs)  # noqa: E501
        else:
            (data) = self.add_product_with_http_info(product, **kwargs)  # noqa: E501
            return data

    def add_product_with_http_info(self, product, **kwargs):  # noqa: E501
        """add_product  # noqa: E501

        Creates a new product in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_product_with_http_info(product, async=True)
        >>> result = thread.get()
        ...
        if ('product' not in params or
            ...
            raise ValueError("Missing the required parameter `product` when calling `add_product`")  # noqa: E501
    ...
    def delete_product_by_id(self, id, **kwargs):  # noqa: E501
        """delete_product_by_id  # noqa: E501

        deletes a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_product_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_product_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_product_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_product_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """delete_product_by_id  # noqa: E501

        deletes a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_product_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_product_by_id`")  # noqa: E501
    ...
    def get_product_by_id(self, id, **kwargs):  # noqa: E501
        ...
        Returns a product based on a single ID  ### Includes You can give the following values on includes parameter: `brands, categories, routes, stocks`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_products(self, **kwargs):  # noqa: E501
        ...
        Returns all products from the system that the user has access to  ### Includes You can give the following values on includes parameter: `brands, categories, routes, stocks`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def update_product_by_id(self, id, tax, **kwargs):  # noqa: E501
        """update_product_by_id  # noqa: E501

        update a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_by_id(id, tax, async=True)
        >>> result = thread.get()

        :param async bool
        :param int id: ID of product to update (required)
        :param Product tax: Product to add to the store (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_product_by_id_with_http_info(id, tax, **kwargs)  # noqa: E501
        else:
            (data) = self.update_product_by_id_with_http_info(id, tax, **kwargs)  # noqa: E501
            return data

    def update_product_by_id_with_http_info(self, id, tax, **kwargs):  # noqa: E501
        """update_product_by_id  # noqa: E501

        update a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_by_id_with_http_info(id, tax, async=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_product_by_id`")  # noqa: E501
        # verify the required parameter 'tax' is set
        if ('tax' not in params or
                params['tax'] is None):
            raise ValueError("Missing the required parameter `tax` when calling `update_product_by_id`")  # noqa: E501
    ...
    def update_product_by_id_0(self, id, tax, **kwargs):  # noqa: E501
        """update_product_by_id_0  # noqa: E501

        update a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_by_id_0(id, tax, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_product_by_id_0_with_http_info(id, tax, **kwargs)  # noqa: E501
        else:
            (data) = self.update_product_by_id_0_with_http_info(id, tax, **kwargs)  # noqa: E501
            return data

    def update_product_by_id_0_with_http_info(self, id, tax, **kwargs):  # noqa: E501
        """update_product_by_id_0  # noqa: E501

        update a single product based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_by_id_0_with_http_info(id, tax, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_product_by_id_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_product_by_id_0`")  # noqa: E501
        # verify the required parameter 'tax' is set
        if ('tax' not in params or
                params['tax'] is None):
            raise ValueError("Missing the required parameter `tax` when calling `update_product_by_id_0`")  # noqa: E501
