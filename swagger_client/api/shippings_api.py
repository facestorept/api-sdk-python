...
class ShippingsApi(object):
    ...
    def add_shipping(self, shipping, **kwargs):  # noqa: E501
        """add_shipping  # noqa: E501

        Creates a new shipping in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_shipping(shipping, async=True)
        >>> result = thread.get()

        :param async bool
        :param Shipping shipping: Shipping to add to the store (required)
        ...
        if kwargs.get('async'):
            return self.add_shipping_with_http_info(shipping, **kwargs)  # noqa: E501
        else:
            (data) = self.add_shipping_with_http_info(shipping, **kwargs)  # noqa: E501
            return data

    def add_shipping_with_http_info(self, shipping, **kwargs):  # noqa: E501
        """add_shipping  # noqa: E501

        Creates a new shipping in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_shipping_with_http_info(shipping, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_shipping" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'shipping' is set
        if ('shipping' not in params or
                params['shipping'] is None):
            raise ValueError("Missing the required parameter `shipping` when calling `add_shipping`")  # noqa: E501
    ...
    def delete_shipping_by_id(self, id, **kwargs):  # noqa: E501
        """delete_shipping_by_id  # noqa: E501

        deletes a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_shipping_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_shipping_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_shipping_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_shipping_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """delete_shipping_by_id  # noqa: E501

        deletes a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_shipping_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_shipping_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_shipping_by_id`")  # noqa: E501
    ...
    def get_shipping_by_id(self, id, **kwargs):  # noqa: E501
        """get_shipping_by_id  # noqa: E501

        Returns a shipping based on a single ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_shipping_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_shipping_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_shipping_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_shipping_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_shipping_by_id  # noqa: E501

        Returns a shipping based on a single ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_shipping_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_shipping_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_shipping_by_id`")  # noqa: E501
    ...
    def get_shippings(self, **kwargs):  # noqa: E501
        """get_shippings  # noqa: E501

        Returns all shippings from the system that the user has access to  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_shippings(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_shippings_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_shippings_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_shippings_with_http_info(self, **kwargs):  # noqa: E501
        """get_shippings  # noqa: E501

        Returns all shippings from the system that the user has access to  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_shippings_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def update_shipping_by_id(self, id, tax, **kwargs):  # noqa: E501
        """update_shipping_by_id  # noqa: E501

        update a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_shipping_by_id(id, tax, async=True)
        >>> result = thread.get()

        :param async bool
        :param int id: ID of shipping to update (required)
        :param Shipping tax: Shipping to update in store (required)
        :return: InlineResponse2013
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_shipping_by_id_with_http_info(id, tax, **kwargs)  # noqa: E501
        else:
            (data) = self.update_shipping_by_id_with_http_info(id, tax, **kwargs)  # noqa: E501
            return data

    def update_shipping_by_id_with_http_info(self, id, tax, **kwargs):  # noqa: E501
        """update_shipping_by_id  # noqa: E501

        update a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_shipping_by_id_with_http_info(id, tax, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_shipping_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_shipping_by_id`")  # noqa: E501
        # verify the required parameter 'tax' is set
        if ('tax' not in params or
                params['tax'] is None):
            raise ValueError("Missing the required parameter `tax` when calling `update_shipping_by_id`")  # noqa: E501
    ...
    def update_shipping_by_id_0(self, id, tax, **kwargs):  # noqa: E501
        """update_shipping_by_id_0  # noqa: E501

        update a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_shipping_by_id_0(id, tax, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_shipping_by_id_0_with_http_info(id, tax, **kwargs)  # noqa: E501
        else:
            (data) = self.update_shipping_by_id_0_with_http_info(id, tax, **kwargs)  # noqa: E501
            return data

    def update_shipping_by_id_0_with_http_info(self, id, tax, **kwargs):  # noqa: E501
        """update_shipping_by_id_0  # noqa: E501

        update a single shipping based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_shipping_by_id_0_with_http_info(id, tax, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_shipping_by_id_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_shipping_by_id_0`")  # noqa: E501
        # verify the required parameter 'tax' is set
        if ('tax' not in params or
                params['tax'] is None):
            raise ValueError("Missing the required parameter `tax` when calling `update_shipping_by_id_0`")  # noqa: E501
