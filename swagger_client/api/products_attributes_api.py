...
class ProductsAttributesApi(object):
    ...
    def add_products_attributes(self, attribute, **kwargs):  # noqa: E501
        """add_products_attributes  # noqa: E501

        Creates a new attribute of products in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_products_attributes(attribute, async=True)
        >>> result = thread.get()

        :param async bool
        :param Attribute attribute: Attribute to add to the store (required)
        ...
        if kwargs.get('async'):
            return self.add_products_attributes_with_http_info(attribute, **kwargs)  # noqa: E501
        else:
            (data) = self.add_products_attributes_with_http_info(attribute, **kwargs)  # noqa: E501
            return data

    def add_products_attributes_with_http_info(self, attribute, **kwargs):  # noqa: E501
        """add_products_attributes  # noqa: E501

        Creates a new attribute of products in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_products_attributes_with_http_info(attribute, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_products_attributes" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('attribute' not in params or
            ...
            raise ValueError("Missing the required parameter `attribute` when calling `add_products_attributes`")  # noqa: E501
    ...
    def delete_product_attribute_by_id(self, id, **kwargs):  # noqa: E501
        """delete_product_attribute_by_id  # noqa: E501

        deletes a single attribute of products based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_product_attribute_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_product_attribute_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_product_attribute_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_product_attribute_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """delete_product_attribute_by_id  # noqa: E501

        deletes a single attribute of products based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_product_attribute_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_product_attribute_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_product_attribute_by_id`")  # noqa: E501
    ...
    def get_product_attribute_by_id(self, id, **kwargs):  # noqa: E501
        """get_product_attribute_by_id  # noqa: E501

        Returns a attribute of products based on a single ID  ### Includes You can give the following values on includes parameter: `options`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_product_attribute_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_product_attribute_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_product_attribute_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_product_attribute_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_product_attribute_by_id  # noqa: E501

        Returns a attribute of products based on a single ID  ### Includes You can give the following values on includes parameter: `options`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_product_attribute_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_product_attribute_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_product_attribute_by_id`")  # noqa: E501
    ...
    def get_products_attributes(self, **kwargs):  # noqa: E501
        """get_products_attributes  # noqa: E501

        Returns all attributes of products from the system that the user has access to  ### Includes You can give the following values on includes parameter: `options`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_products_attributes(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_products_attributes_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_products_attributes_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_products_attributes_with_http_info(self, **kwargs):  # noqa: E501
        """get_products_attributes  # noqa: E501

        Returns all attributes of products from the system that the user has access to  ### Includes You can give the following values on includes parameter: `options`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_products_attributes_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_products_attributes" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def update_product_attribute_by_id(self, id, product_attribute, **kwargs):  # noqa: E501
        """update_product_attribute_by_id  # noqa: E501

        update a single attribute of products based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_attribute_by_id(id, product_attribute, async=True)
        >>> result = thread.get()

        :param async bool
        :param int id: ID of attribute to update (required)
        :param Attribute product_attribute: Attribute to add to the store (required)
        :return: Attribute
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_product_attribute_by_id_with_http_info(id, product_attribute, **kwargs)  # noqa: E501
        else:
            (data) = self.update_product_attribute_by_id_with_http_info(id, product_attribute, **kwargs)  # noqa: E501
            return data

    def update_product_attribute_by_id_with_http_info(self, id, product_attribute, **kwargs):  # noqa: E501
        """update_product_attribute_by_id  # noqa: E501

        update a single attribute of products based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_product_attribute_by_id_with_http_info(id, product_attribute, async=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'product_attribute']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_product_attribute_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_product_attribute_by_id`")  # noqa: E501
        # verify the required parameter 'product_attribute' is set
        if ('product_attribute' not in params or
                params['product_attribute'] is None):
            raise ValueError("Missing the required parameter `product_attribute` when calling `update_product_attribute_by_id`")  # noqa: E501
        ...
        body_params = None
        if 'product_attribute' in params:
            body_params = params['product_attribute']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
