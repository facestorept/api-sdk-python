...
class BrandsApi(object):
    ...
    def add_brands(self, brand, **kwargs):  # noqa: E501
        """add_brands  # noqa: E501

        Creates a new brand in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_brands(brand, async=True)
        >>> result = thread.get()

        :param async bool
        :param Brand brand: Brand to add to the store (required)
        ...
        if kwargs.get('async'):
            return self.add_brands_with_http_info(brand, **kwargs)  # noqa: E501
        else:
            (data) = self.add_brands_with_http_info(brand, **kwargs)  # noqa: E501
            return data

    def add_brands_with_http_info(self, brand, **kwargs):  # noqa: E501
        """add_brands  # noqa: E501

        Creates a new brand in the store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_brands_with_http_info(brand, async=True)
        >>> result = thread.get()
        ...
        if ('brand' not in params or
            ...
            raise ValueError("Missing the required parameter `brand` when calling `add_brands`")  # noqa: E501
    ...
    def delete_brand_by_id(self, id, **kwargs):  # noqa: E501
        """delete_brand_by_id  # noqa: E501

        Deletes a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_brand_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.delete_brand_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_brand_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_brand_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """delete_brand_by_id  # noqa: E501

        Deletes a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_brand_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_brand_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_brand_by_id`")  # noqa: E501
    ...
    def get_brand_by_id(self, id, **kwargs):  # noqa: E501
        """get_brand_by_id  # noqa: E501

        Returns a brand based on a single ID  ### Includes You can give the following values on includea parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_brand_by_id(id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_brand_by_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_brand_by_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_brand_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_brand_by_id  # noqa: E501

        Returns a brand based on a single ID  ### Includes You can give the following values on includea parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_brand_by_id_with_http_info(id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'includes', 'limit']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_brand_by_id`")  # noqa: E501
    ...
    def get_brands(self, **kwargs):  # noqa: E501
        """get_brands  # noqa: E501

        Returns all brands from the system that the user has access to  ### Includes You can give the following values on includes parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_brands(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_brands_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_brands_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_brands_with_http_info(self, **kwargs):  # noqa: E501
        """get_brands  # noqa: E501

        Returns all brands from the system that the user has access to  ### Includes You can give the following values on includes parameter: `routes, products`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_brands_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def update_category_by_id(self, id, brand, **kwargs):  # noqa: E501
        """update_category_by_id  # noqa: E501

        Update a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id(id, brand, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_category_by_id_with_http_info(id, brand, **kwargs)  # noqa: E501
        else:
            (data) = self.update_category_by_id_with_http_info(id, brand, **kwargs)  # noqa: E501
            return data

    def update_category_by_id_with_http_info(self, id, brand, **kwargs):  # noqa: E501
        """update_category_by_id  # noqa: E501

        Update a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id_with_http_info(id, brand, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_category_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_category_by_id`")  # noqa: E501
        # verify the required parameter 'brand' is set
        if ('brand' not in params or
                params['brand'] is None):
            raise ValueError("Missing the required parameter `brand` when calling `update_category_by_id`")  # noqa: E501
    ...
    def update_category_by_id_0(self, id, brand, **kwargs):  # noqa: E501
        """update_category_by_id_0  # noqa: E501

        Update a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id_0(id, brand, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_category_by_id_0_with_http_info(id, brand, **kwargs)  # noqa: E501
        else:
            (data) = self.update_category_by_id_0_with_http_info(id, brand, **kwargs)  # noqa: E501
            return data

    def update_category_by_id_0_with_http_info(self, id, brand, **kwargs):  # noqa: E501
        """update_category_by_id_0  # noqa: E501

        Update a single brand based on the ID supplied  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_category_by_id_0_with_http_info(id, brand, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_category_by_id_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_category_by_id_0`")  # noqa: E501
        # verify the required parameter 'brand' is set
        if ('brand' not in params or
                params['brand'] is None):
            raise ValueError("Missing the required parameter `brand` when calling `update_category_by_id_0`")  # noqa: E501
